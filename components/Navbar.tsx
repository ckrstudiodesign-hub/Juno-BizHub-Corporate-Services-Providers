      ...
      <div className={`max-w-[1600px] mx-auto px-4 sm:px-6 transition-all duration-500`}>
        <div className={`relative flex justify-between items-center px-6 rounded-full border transition-all duration-500 ${scrolled ? 'bg-black/60 backdrop-blur-2xl border-white/10 shadow-2xl h-16' : 'bg-black/5 backdrop-blur-md border-white/10 h-20'}`}>
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" className="group flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-xl md:text-2xl font-black tracking-tighter text-white group-hover:text-electric-sapphire transition-colors">
                  Juno <span className="text-electric-sapphire">BizHUB</span>
                </span>
                <span className="text-[10px] uppercase tracking-[0.4em] text-gray-400/80 font-bold -mt-1 group-hover:text-electric-sapphire/80 transition-colors whitespace-nowrap">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            <Link 
              href="/" 
              className="flex items-center gap-2 px-5 py-2 rounded-full text-sm font-bold transition-all text-white/90 hover:text-electric-sapphire hover:bg-white/5"
            >
            ...
            {menuItems.map((item) => (
              ...
              >
                <button className={`flex items-center gap-2 px-5 py-2 rounded-full text-sm font-bold transition-all ${activeDropdown === item.title ? 'text-electric-sapphire bg-white/10' : 'text-white/90 hover:text-electric-sapphire hover:bg-white/5'}`}>
                  {item.icon}
                  {item.title} 
                  ...
                  {activeDropdown === item.title && (
                    ...
                    >
                      {/* <div className="px-4 py-2 border-b border-white/5 mb-2">
                         <span className="text-[10px] uppercase tracking-widest text-electric-sapphire font-bold">Solutions for {item.title}</span>
                      </div> */}
                      <div className="grid grid-cols-1 gap-1 px-2">
                        {item.links.map((link) => (
                          <Link
                            ...
                            className="flex items-center justify-between px-4 py-3 text-sm rounded-xl text-gray-400 hover:bg-electric-sapphire hover:text-black transition-all group/item"
                          >
          ...
          <div className="lg:hidden flex items-center">
            <button
              ...
              className="p-2 text-gray-400 hover:text-electric-sapphire transition-colors"
            >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            >
              {/* Decorative Glow */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-electric-sapphire/5 blur-[100px] rounded-full -mr-32 -mt-32 pointer-events-none"></div>
              ...
              <div className="flex-1 overflow-y-auto px-6 space-y-4">
                ...
                >
                  <div className="text-electric-sapphire text-2xl">
                  ...
                  return (
                    <div key={item.title} className="space-y-2">
                       <button 
                         ...
                         className={`w-full flex items-center justify-between p-5 rounded-2xl border transition-all duration-300 ${isExpanded ? 'bg-electric-sapphire border-electric-sapphire text-black' : 'bg-white/5 border-white/5 text-gray-300'}`}
                       >
                         <div className="flex items-center gap-4">
                           <div className={`transition-colors text-2xl ${isExpanded ? 'text-black' : 'text-electric-sapphire'}`}>
                              {item.icon}
                           </div>
                             ...
                             {item.links.map((link, lIdx) => (
                               ...
                               >
                                 ...
                                 >
                                   ...
                                   <ArrowRight size={14} className="text-electric-sapphire opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all" />
                                 </Link>
                               </motion.div>
                             ))}
                           </motion.div>
                ...
                <div className="pt-6 space-y-3">
                   <Link 
                     ...
                     onClick={() => setIsOpen(false)}
                     className="flex items-center gap-4 p-5 rounded-3xl bg-electric-sapphire text-black shadow-[0_15px_30px_rgba(84,101,255,0.3)]"
                   >
                   ...
                   >
                     <div className="w-10 h-10 bg-electric-sapphire/10 rounded-xl flex items-center justify-center text-electric-sapphire">
                        <Users size={20} />
                     </div>
              ...
              <div className="mt-auto px-6 pt-8 border-t border-white/5 space-y-4">
                  <div className="flex items-center justify-between">
                    <a href="tel:+971 54 129 0038" className="p-4 bg-white/5 rounded-2xl flex-1 flex flex-col items-center gap-2 group border border-transparent active:border-electric-sapphire/50 transition-all">
                       <Phone size={18} className="text-electric-sapphire" />
                       <span className="text-[10px] font-black tracking-widest uppercase text-gray-500">Call Now</span>
                    </a>
                    <div className="w-4" />
                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=junobizhub295%40gmail.com" target="_blank" rel="noopener noreferrer" className="p-4 bg-white/5 rounded-2xl flex-1 flex flex-col items-center gap-2 group border border-transparent active:border-electric-sapphire/50 transition-all">
                       <Globe2 size={18} className="text-electric-sapphire" />
